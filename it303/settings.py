"""
Django settings for it303 project.
...
SECRET_KEY = 'django-insecure-m&*(wwrio(4es$r*2_7uc-5w(8-_b072skn3&t_^qtkehvkjc*'
...
WSGI_APPLICATION = 'it303.wsgi.application'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://127.0.0.1:6379/1',  # Redis running on localhost and using database 1
        'OPTIONS': {
